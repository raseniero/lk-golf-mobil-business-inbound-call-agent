...
class TestPhraseDetectionPerformance:
    ...
    def setup_method(self):
        ...
        self.large_phrase_set = {
            "goodbye", "end call", "that's all", "thank you", "bye",
            "see you later", "have a good day", "take care", "farewell",
            "so long", "until next time", "call me back", "talk soon",
            "catch you later", "peace out", "signing off", "gotta go",
            "wrap up", "finish up", "done here", "all done", "complete",
            "end session", "close call", "hang up", "disconnect",
            "talk later", "until tomorrow", "see you soon", "good night",
            "good morning", "have a nice day", "take it easy", "be well"
        }
    ...
    def test_cache_effectiveness(self):
        ...
        assert cache_size_after <= cache_size_before + 5  # Allow some growth for multi-word patterns