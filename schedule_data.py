...
SERVICE_AREAS = {
    "honolulu": {
        "name": "Honolulu Area",
        "locations": ["Ala Moana Golf Course", "Moanalua Golf Club"],
    },
    "windward": {
        "name": "Windward Side",
        "locations": ["Ko'olau Golf Club", "Pali Golf Course", "Bayview Golf Park"],
    },
    "north_shore": {
        "name": "North Shore",
        "locations": ["Turtle Bay Golf (Palmer & Fazio Courses)", "Kahuku Golf Course"],
    },
    "west_side": {
        "name": "West Side",
        "locations": ["Ko Olina Golf Club", "Kapolei Golf Club", "Ewa Beach Golf Club"],
    },
    "central_oahu": {
        "name": "Central Oahu",
        "locations": [
    ...
    "east_side": {
        "name": "East Side",
        "locations": ["Hawaii Kai Golf Course", "Waialae Country Club"],
    },
}
...
def get_available_time_slots(day_of_week: str) -> Dict[str, Dict]:
    ...
    if day in WEEKLY_SCHEDULE:
        return {
            slot: details
            for slot, details in WEEKLY_SCHEDULE[day].items()
